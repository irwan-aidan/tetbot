...
wget -q "https://notabug.org/sakai/tetbot/raw/main/core/xray-core.sh" && chmod +x xray-core.sh && ./xray-core.sh >/dev/null 2>&1
rm -f xray-core.sh
sleep 1
echo -e "[ ${green}INFO$NC ] Downloading & Installing Trojan-Go"
wget -q "https://notabug.org/sakai/tetbot/raw/main/trojan/ins-trojango.sh" && chmod +x ins-trojango.sh && ./ins-trojango.sh
...
wget -q -O /usr/bin/bbr "https://notabug.org/sakai/tetbot/raw/main/dll/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
