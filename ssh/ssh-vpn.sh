...
wget -O /etc/pam.d/common-password "https://notabug.org/sakai/tetbot/raw/main/ssh/password"
...
wget -q -O /usr/bin/badvpn-udpgw "https://notabug.org/sakai/tetbot/raw/main/ssh/newudpgw"
...
# install squid
cd
wget -O /etc/squid/squid.conf "https://notabug.org/sakai/tetbot/raw/main/ssh/squid3.conf"
...
wget -q https://notabug.org/sakai/tetbot/raw/main/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://notabug.org/sakai/tetbot/raw/main/banner/issue.net"
