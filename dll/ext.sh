...
wget -q -O /usr/bin/add-host "https://notabug.org/sakai/tetbot/raw/main/ssh/add-host.sh" && chmod +x /usr/bin/add-host
wget -q -O /usr/bin/about "https://notabug.org/sakai/tetbot/raw/main/ssh/about.sh" && chmod +x /usr/bin/about
